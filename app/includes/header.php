...
<div class="app-layout">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?= url('agenda') ?>" class="nav-link <?= $page === 'agenda' ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                Agenda
            </a>
            <a href="<?= url('clients') ?>" class="nav-link <?= in_array($page, ['clients','client-new','client-edit','client-view','client-evolution','client-objectifs','client-documents','client-timeline']) ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                Clients
            </a>
            <a href="<?= url('consultations') ?>" class="nav-link <?= in_array($page, ['consultations','consultation-new','consultation-step1','consultation-step2','consultation-step3','consultation-step4','consultation-step5','consultation-step6','consultation-v2','consultation-view']) ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>
                Consultations
            </a>

            <div class="nav-section" style="margin-top: 1rem;">Gestion</div>
            <a href="<?= url('factures') ?>" class="nav-link <?= in_array($page, ['factures','facture-new','facture-edit','facture-view']) ? 'active' : '' ?>">
            ...
            <a href="<?= url('statistiques') ?>" class="nav-link <?= $page === 'statistiques' ? 'active' : '' ?>">
            ...
            <a href="<?= url('ressources') ?>" class="nav-link <?= in_array($page, ['ressources','ressource-view']) ? 'active' : '' ?>">
                ...
                Ressources (phyto, aroma...)
            </a>
            <a href="<?= url('phv-templates') ?>" class="nav-link <?= in_array($page, ['phv-templates','phv-template-edit']) ? 'active' : '' ?>">
            ...
            <a href="<?= url('protocoles') ?>" class="nav-link <?= in_array($page, ['protocoles','protocole-edit']) ? 'active' : '' ?>">
            ...
            <a href="<?= url('recettes') ?>" class="nav-link <?= in_array($page, ['recettes','recette-edit']) ? 'active' : '' ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>
                Recettes
            </a>

            <div class="nav-section" style="margin-top: 1rem;">Configuration</div>
            <a href="<?= url('parametres') ?>" class="nav-link <?= in_array($page, ['parametres','parametres-cabinet','parametres-prestations']) ? 'active' : '' ?>">
    ...
    <main class="main-content">
        <!-- Barre mobile (visible uniquement en dessous de 768px) -->
        <div class="mobile-topbar">
            <button type="button" id="menuToggle" class="mobile-menu-btn" aria-label="Ouvrir le menu">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="24" height="24"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
            </button>
            <span class="mobile-topbar-brand">PHV Naturo</span>
        </div>
<?php
$flash = flashGet();
if ($flash): ?>
