...
function getFichesPathologies(): array {
    return [
        ...
        // ==========================================
        // NOUVELLES PATHOLOGIES (cours ESN complémentaires)
        // ==========================================
array (
  'nom' => 'Pancréatite',
  'systeme' => 'Système digestif',
  'description' => 'Inflammation aiguë du pancréas (œdème et/ou nécrose) se traduisant par une douleur violente dans la moitié supérieure de l\'abdomen.',
  'causes' => 'Alcoolisme. Migration de calculs biliaires dans les voies biliaires : un calcul peut obstruer de façon temporaire la jonction entre le canal cholédoque et le canal pancréatique (ampoule de Vater), déclenchant la crise.',
  'signes_cliniques' => 'Douleur violente dans la moitié supérieure de l\'abdomen.',
  'conseils_alimentation' => 'En phase aiguë, mise au repos complète du système digestif (arrêt de l\'alimentation en milieu médical). Une fois la crise passée, épargne digestive progressive et lutte contre l\'inflammation.',
  'aliments_eviter' => 'Alcool. Graisses en excès, qui sollicitent fortement la sécrétion pancréatique.',
  'aliments_privilegier' => 'Reprise alimentaire progressive et légère après la phase aiguë, en lien avec la cause retrouvée (cf. fiche Lithiases biliaires si calculs, fiche NASH / syndrome métabolique si terrain métabolique).',
  'conseils_activite' => 'Non documenté dans la source ; se référer à l\'état général du consultant après l\'épisode aigu.',
  'conseils_stress' => 'Non documenté dans la source pour cette pathologie.',
  'conseils_routine' => 'Rechercher et corriger la cause déclenchante (sevrage alcool, prise en charge des calculs biliaires) pour éviter les récidives.',
  'complements' => 'Non documenté dans la source.',
  'phytotherapie' => 'Non documenté dans la source pour la phase aiguë. En cas de terrain de calculs biliaires associés, ne pas utiliser de plantes cholérétiques/cholagogues (voir fiche Lithiases biliaires) : risque de provoquer la migration d\'un calcul et une nouvelle pancréatite.',
  'aromatherapie' => 'Non documenté dans la source.',
  'notes' => 'Diagnostic : mesure des enzymes pancréatiques sanguines ; si taux anormalement élevé, confirmation par échographie et scanner. Allopathie préventive : soulager la douleur en mettant le système digestif au repos et en luttant contre l\'inflammation (arrêt de l\'alimentation, inhibiteurs enzymatiques, réhydratation, antibiotique, ablation de la vésicule biliaire si calculs en cause). Fiche source (cours) très succincte sur cette pathologie : de nombreuses rubriques (bilans naturopathiques, hydrologie, gemmothérapie, compléments) n\'étaient pas renseignées dans le support de cours.',
),
array (
  'nom' => 'Lithiases biliaires',
  'systeme' => 'Système digestif',
  'description' => 'Calculs qui se forment dans la vésicule biliaire et qui peuvent migrer dans les voies excrétrices biliaires. Souvent asymptomatiques, parfois responsables de douleurs sous les côtes en haut et à droite de l\'abdomen.',
  'causes' => 'Terrain individuel. Variation de la composition chimique de la bile avec agrégation de cristaux de matière organique (cholestérol calcifié). Facteurs favorisants : diabète, âge avancé, grossesses multiples, obésité.',
  'signes_cliniques' => 'Le plus souvent asymptomatique. Parfois douleurs sous les côtes, en haut et à droite de l\'abdomen. Troubles digestifs possibles. Selles grasses à rechercher.',
  'conseils_alimentation' => 'Privilégier les bonnes graisses. Éviter les produits ultra-transformés. Assurer une bonne hydratation.',
  'aliments_eviter' => 'Produits ultra-transformés. Graisses de mauvaise qualité.',
  'aliments_privilegier' => 'Bonnes graisses (qualité à privilégier). Hydratation suffisante et régulière.',
  'conseils_activite' => 'Activités douces à modérées : marche rapide, natation, vélo, yoga, pilates. Éviter les efforts brusques en cas de calculs connus.',
  'conseils_stress' => 'Non documenté spécifiquement dans la source.',
  'conseils_routine' => 'Bonne hydratation régulière. Interroger le terrain : antécédents familiaux de calculs biliaires, statut de la vésicule biliaire (encore en place ou non), taux de cholestérol, aspect des selles (grasses ?).',
  'complements' => 'En cas de suspicion de mauvaise qualité de bile : vérifier une possible carence en fer, en vitamine B3, un manque de cholestérol, une dysbiose, une malabsorption des vitamines A/D/E/K, ou un manque de L-glycine ou de taurine (à confirmer par bilan, ex. labo LIMS).',
  'phytotherapie' => 'ATTENTION : en cas d\'antécédent de calculs biliaires, ne pas prescrire de plantes dites « hépatiques ». La majorité de ces plantes sont cholérétiques et cholagogues : elles augmentent la production de bile et la contraction de la vésicule biliaire, provoquant une vidange vésiculaire qui peut faire migrer un calcul et déclencher une pancréatite. Exemples de plantes à proscrire en cas de calculs : artichaut, radis noir, chardon-Marie, boldo, pissenlit, desmodium.',
  'aromatherapie' => 'Non documenté dans la source (prudence par extension du même principe de précaution que pour la phytothérapie hépatique).',
  'notes' => 'Diagnostic : échographie. Évolution/risque : un calcul peut boucher le canal pancréatique (obstruction de l\'ampoule de Vater) et provoquer une pancréatite. Allopathie : éviter la migration des calculs vers les voies biliaires (donc la pancréatite) ; selon la localisation, pas de traitement ou ablation de la vésicule biliaire. Naturopathie : si ablation de la vésicule biliaire, la bile n\'est plus stockée et se déverse en continu, rendant la digestion des graisses souvent insuffisante ; il faut alors soutenir la digestion des graisses et optimiser la qualité de la bile.',
),
array (
  'nom' => 'Hernie hiatale',
  'systeme' => 'Système digestif',
  'description' => 'Poche formée par la partie supérieure de l\'estomac qui passe au-dessus du diaphragme par le hiatus œsophagien. Le RGO en est une conséquence fréquente.',
  'causes' => 'Cause précise inconnue. Facteurs favorisants : RGO préexistant, obésité (augmentation de la pression abdominale), déminéralisation (relâchement des tissus), vieillissement (perte d\'élasticité), stress chronique.',
  'signes_cliniques' => 'Brûlure œsophagienne, remontées acides, éructations, régurgitations, hoquet, toux, douleurs abdominales.',
  'conseils_alimentation' => 'Revoir l\'alimentation : bien mastiquer, manger lentement et à distance du coucher, repas pris dans le calme, fractionner les repas, éviter les repas copieux ou tardifs. Attendre 3h avant de s\'allonger après un repas. Alimentation dissociée et/ou pauvre en FODMAPs selon les symptômes. Boire en dehors des repas plutôt que pendant.',
  'aliments_eviter' => 'Plats épicés. Graisses en excès. Agents irritants (alcool, tabac).',
  'aliments_privilegier' => 'En cas de déminéralisation : aliments riches en minéraux (algues, aliments crus, herbes aromatiques, plasma de Quinton). En cas d\'insuffisance enzymatique : plantes amères (gentiane, artichaut, radis noir).',
  'conseils_activite' => 'Activité douce et relaxante (à privilégier plutôt qu\'une activité intense).',
  'conseils_stress' => 'Réduire le stress : yoga, méditation, exercices de respiration, sophrologie.',
  'conseils_routine' => 'Relever la tête du lit le soir. Fractionner les repas, épargne digestive. Hydratation régulière en eau plate, en dehors des repas.',
  'complements' => 'Enzymes digestives, bromélaïne, HCl de bétaine (si insuffisance enzymatique/hypochlorhydrie associée). Plasma de Quinton et algues pour reminéraliser.',
  'phytotherapie' => 'Plantes amères en cas d\'insuffisance enzymatique ou biliaire : gentiane, radis noir, artichaut, pour augmenter les sécrétions de sucs digestifs. Argile par voie orale possible (attention, peut provoquer une constipation).',
  'aromatherapie' => 'Non spécifiquement documentée pour la hernie hiatale dans la source (voir gemmothérapie).',
  'notes' => 'Diagnostic : fibroscopie, radiographie. Évolution/risque : œsophagite, ulcération, endobrachyœsophage. Gemmothérapie citée dans le cours (via le lien au RGO) : bourgeon de figuier et bourgeons en lien avec la gestion du stress, tilleul. Miel de Manuka également cité. Enquête à mener : rechercher un RGO associé, les habitudes alimentaires, la consommation d\'excitants (alcool, tabac), le contexte de stress, les antécédents de gastro, les carences et infections ORL. Allopathie : pansements gastriques (Gaviscon) en 1ère intention, IPP (Lansoprazole, Oméprazole, Rabéprazole, Ésoméprazole, Pantoprazole) en 2ème intention, chirurgie anti-reflux en cas d\'échec.',
),
array (
  'nom' => 'Glossite',
  'systeme' => 'Système digestif',
  'description' => 'Inflammation de la langue, pouvant se présenter sous forme de langue géographique. La langue devient rouge, dépapillée, voire fissurée par endroits, avec une sensation de gêne ou de brûlure au contact de certains aliments. Pose souvent la question d\'un terrain auto-immun.',
  'causes' => 'Choc émotionnel possible. Perméabilité intestinale. Maladie de Biermer (maladie auto-immune où les anticorps sont dirigés contre le facteur intrinsèque, entraînant une carence en B12). Maladie de Gougerot-Sjögren (maladie auto-immune entraînant un syndrome sec général, avec anticorps anti-SSA et anti-SSB). Carence en fer.',
  'signes_cliniques' => 'Langue rouge, dépapillée, voire fissurée par endroits. Sensation de gêne ou de brûlure au contact de certains aliments.',
  'conseils_alimentation' => 'En cas de perméabilité intestinale associée : limitation ou suppression des aliments irritants/allergéniques pour la muqueuse.',
  'aliments_eviter' => 'Aliments irritants ou allergéniques identifiés en cas de perméabilité intestinale associée.',
  'aliments_privilegier' => 'Non détaillé spécifiquement au-delà du soutien de la barrière intestinale (cf. programme des 4R).',
  'conseils_activite' => 'Non documenté dans la source.',
  'conseils_stress' => 'Explorer la piste d\'un possible choc émotionnel à l\'origine ou au déclenchement des symptômes. Travailler le rapport au stress et à l\'anxiété.',
  'conseils_routine' => 'Optimisation de la barrière intestinale via le « programme des 4R ».',
  'complements' => 'En cas de syndrome de Gougerot-Sjögren : oméga 7 (huile d\'argousier) pour limiter le syndrome sec. En cas de carence en fer : bisglycinate ou picolinate de fer associé à de la lactoferrine (qui améliore l\'assimilation du fer) et de la vitamine C. En cas de perméabilité intestinale : probiotiques spécialisés pour maintenir l\'équilibre symbiotique.',
  'phytotherapie' => 'En cas de Gougerot-Sjögren : modulation du système immunitaire pour augmenter les lymphocytes Treg avec astragale, curcuma, sureau, réglisse — incompatible avec la prise d\'immunosuppresseurs.',
  'aromatherapie' => 'Non documenté dans la source.',
  'notes' => 'Enquête à mener : dosages en ferritine et B12, dosage des anticorps anti-SSA / anti-SSB, antécédents familiaux de maladies auto-immunes, recherche d\'un événement déclencheur (choc émotionnel). Si carence en fer, rechercher la cause : micro-hémorragies internes liées au port d\'un stérilet, règles hémorragiques, MICI, hypochlorhydrie. Bilans utiles : typage lymphocytaire TH1/TH2/TH17/Treg (profil auto-immun), zonuline sanguine ou fécale (perméabilité intestinale), statut en acides gras avec rapport AA/EPA (inflammation) et taux d\'acide palmitoléique oméga 7 (sécheresse des muqueuses). Allopathie : si Biermer, injections intramusculaires de vitamine B12 pour maintenir un taux stable et éviter/corriger l\'anémie, avec surveillance de l\'estomac par fibroscopie tous les deux ans ; si Gougerot-Sjögren, corticoïdes, immunosuppresseurs, sialagogues et collyres ; si carence en fer, Ferrostrane, Tardyferon. Naturopathie : si maladie de Biermer confirmée, aucun accompagnement naturopathique curatif possible sur la cause elle-même ; l\'accompagnement porte alors sur le renforcement de la barrière intestinale comme pour toute pathologie auto-immune.',
),
array (
  'nom' => 'Fibrillation auriculaire',
  'systeme' => 'Système cardio-vasculaire',
  'description' => 'Trouble du rythme cardiaque : l\'activité électrique des oreillettes devient désordonnée, le cœur bat de manière irrégulière, parfois trop vite. Peut survenir par épisodes ou persister.',
  'causes' => 'Signal électrique désordonné des oreillettes qui ne se contractent plus efficacement, favorisant la stagnation du sang dans l\'auricule gauche. Facteurs de risque/liens : hyperthyroïdie (favorise l\'arythmie), apnée du sommeil associée, hypertension, diabète et surpoids qui augmentent le risque.',
  'signes_cliniques' => 'Palpitations et pouls irrégulier, fatigue, essoufflement, vertiges, moindre tolérance à l\'effort. La personne peut aussi ne ressentir aucun symptôme.',
  'conseils_alimentation' => 'Alimentation de type méditerranéen : légumes, fruits, légumineuses, céréales complètes, huile d\'olive, noix et poisson. Limiter l\'alcool. Adapter selon les maladies associées et le traitement en cours ; sous antivitamine K, éviter les variations brusques d\'apport en vitamine K.',
  'aliments_eviter' => 'Alcool (à limiter). Variations brusques des apports en vitamine K si traitement par antivitamine K.',
  'aliments_privilegier' => 'Légumes, fruits, légumineuses, céréales complètes, huile d\'olive, noix, poisson (privilégier les apports alimentaires en magnésium via légumineuses et noix, et en potassium via fruits et légumes).',
  'conseils_activite' => 'Activité régulière adaptée aux capacités de la personne ; arrêt du tabac. Faire valider l\'effort en cas de symptômes ; arrêter en cas de malaise, douleur ou essoufflement inhabituel.',
  'conseils_stress' => 'Sommeil régulier ; relaxation et respiration lente contre l\'anxiété. Évoquer une possible apnée du sommeil en cas de signes évocateurs. Ces mesures ne remplacent pas le traitement de l\'arythmie.',
  'conseils_routine' => 'Sommeil régulier. Surveillance des signes d\'urgence (voir notes) et suivi médical régulier.',
  'complements' => 'Aucune supplémentation systématique : avis médical impératif avant toute prise de potassium, magnésium ou oméga-3 concentrés, en tenant compte de la fonction rénale et des traitements en cours.',
  'phytotherapie' => 'Citées dans le cours ESN pour les palpitations et troubles du rythme : aubépine et agripaume. Pour le stress associé : passiflore, valériane, lotier. Usage traditionnel uniquement, sans preuve de traitement de la fibrillation auriculaire ni de prévention de l\'AVC. En cas de FA confirmée, avis du médecin et du pharmacien obligatoire avant toute plante, en particulier en association avec un anticoagulant, un antiarythmique ou un antihypertenseur ; ne jamais remplacer le traitement prescrit.',
  'aromatherapie' => 'Non documentée spécifiquement dans la source.',
  'notes' => 'Mécanisme : signaux électriques désordonnés → oreillettes inefficaces → stase du sang → caillot possible → risque d\'AVC ischémique ; des battements rapides prolongés peuvent fragiliser le cœur. Liens avec d\'autres systèmes : cerveau (risque de caillot et d\'AVC), thyroïde (hyperthyroïdie favorisant l\'arythmie), sommeil (apnée associée), métabolisme et vaisseaux (hypertension, diabète, surpoids augmentant le risque). Signes d\'urgence à orienter immédiatement (15/112) : visage asymétrique, faiblesse d\'un bras, parole anormale (signes d\'AVC), douleur thoracique, malaise ou essoufflement important, palpitations nouvelles ou persistantes. Diagnostic : ECG, parfois enregistrement prolongé ; le pouls irrégulier seul ne confirme pas le diagnostic. Traitement médical : évaluation du risque d\'AVC et décision d\'anticoagulant, contrôle de la fréquence ou du rythme par médicaments, cardioversion ou ablation selon le cas. Rôle du naturopathe : accompagner l\'hygiène de vie et le suivi, ne jamais modifier le traitement même si le rythme redevient régulier.',
),
array (
  'nom' => 'NASH (stéatose hépatique non alcoolique) et syndrome métabolique',
  'systeme' => 'Système digestif',
  'description' => 'NASH = Stéato-Hépatite Non Alcoolique (à différencier de la NAFLD, Non Alcoholic Fatty Liver Disease, dont elle est la forme inflammatoire et agressive). Accumulation de graisse dans les cellules du foie, associant stéatose, inflammation et destruction cellulaire (cytolyse hépatique). Étroitement liée au syndrome métabolique.',
  'causes' => 'Facteurs favorisants majeurs : obésité abdominale, diabète de type 2, hypertriglycéridémie, syndrome métabolique, sédentarité. Autres facteurs : alimentation hypercalorique riche en sucres rapides et graisses saturées, dysbiose intestinale, stress chronique, surcharge toxique hépatique.',
  'signes_cliniques' => 'Souvent pauci-symptomatique, surtout aux stades précoces, découverte fréquemment fortuite lors d\'un bilan biologique. Fatigue chronique, asthénie. Pesanteur ou douleurs de l\'hypochondre droit. Ballonnements, digestion lente, surtout des graisses. Prise de poids abdominale.',
  'conseils_alimentation' => 'Réduction des sucres rapides et du fructose. Diminution des graisses saturées. Alimentation anti-inflammatoire de type méditerranéenne. Augmentation des fibres (légumes, légumineuses). Réduction des toxiques hépatiques (alcool, pesticides).',
  'aliments_eviter' => 'Sucres rapides et fructose en excès. Graisses saturées. Produits ultra-transformés. Alcool et pesticides (toxiques hépatiques).',
  'aliments_privilegier' => 'Alimentation méditerranéenne. Fibres (légumes, légumineuses). Oméga-3 (poissons gras, huiles de colza, de cameline). Antioxydants naturels (polyphénols, légumes colorés).',
  'conseils_activite' => 'Indispensable : au moins 150 minutes par semaine. Travail cardio et renforcement musculaire, marche, activité douce et mixte. Diminuer la sédentarité (NEAT). Accompagnement progressif selon les goûts et pratiques déjà existantes du consultant.',
  'conseils_stress' => 'Gestion du stress chronique. Travail sur les comportements alimentaires émotionnels. Techniques de relaxation, respiration, cohérence cardiaque. Plantes adaptogènes au besoin.',
  'conseils_routine' => 'Bouillotte sur le foie le soir (à valider selon contexte). Vérifier systématiquement les traitements en cours et les interactions médicamenteuses avant toute proposition phytothérapique.',
  'complements' => 'Oméga-3 EPA/DHA. N-acétylcystéine (NAC). Choline. Vitamine E (avec prudence, dosage encadré). Soutien des phases I (antioxydants) et II (soufre, glycine, taurine) de la détoxification hépatique.',
  'phytotherapie' => 'Chardon-Marie (hépatoprotecteur, +++), curcuma (anti-inflammatoire, +++), desmodium (++), réglisse (+++, hors hypertension artérielle), romarin (++), romarin jeune pousse (gemmothérapie, +++), genévrier jeune pousse (gemmothérapie, ++, hors insuffisance rénale), chrysantellum americanum (++), schisandra (++++). Curcuma en superaliment (à associer au poivre). Artichaut et radis noir utiles (radis noir hors lithiase biliaire). IMPORTANT : vérifier les antécédents de calculs biliaires ; si calculs, ne pas utiliser de plantes cholérétiques stimulant la production de bile, au risque de déclencher une pancréatite.',
  'aromatherapie' => 'Uniquement sur avis spécialisé, et à exclure en cas de pathologie hépatique sévère.',
  'notes' => 'Évolution/risque : peut évoluer vers une fibrose, puis une cirrhose, puis un carcinome hépatique (cancer du foie). Diagnostic : échographie abdominale (foie de volume important, hyperéchogène) ; biologie : transaminases élevées (ALAT souvent > ASAT), triglycérides très élevés, HDL bas, albumine basse, ferritine élevée, LDH augmentée. La NASH/NAFLD est la première cause d\'élévation des transaminases chez le sujet obèse. Bilans recommandés : acides biliaires (qualité de la bile), bilan lipidique complet, transaminases/GGT/PAL, ferritine, glycémie/insuline/HOMA-IR, évaluation de la perméabilité intestinale et du terrain inflammatoire et oxydatif. Liens avec les autres systèmes : dysbiose intestinale et augmentation de la perméabilité intestinale (endotoxémie métabolique) avec passage de LPS bactériens via l\'axe intestin-foie activant le système immunitaire inné ; inflammation chronique de bas grade avec production accrue de cytokines pro-inflammatoires (TNF-α, IL-6) et stress oxydatif hépatique ; insulinorésistance, hyperinsulinémie chronique, déséquilibre leptine/adiponectine, dysfonctionnement de l\'axe foie-pancréas. Allopathie : aucun traitement médicamenteux spécifique, prise en charge basée sur le rééquilibrage alimentaire, la perte de poids progressive, l\'activité physique et le traitement des comorbidités (diabète, dyslipidémie). Précautions générales : ne jamais se substituer au suivi médical, prudence en cas de cirrhose installée, attention aux interactions plantes/médicaments, pas de stimulation biliaire en cas de calculs.',
),
array (
  'nom' => 'Insuffisance et surcharge hépatique',
  'systeme' => 'Système digestif',
  'description' => 'Le foie assure de multiples fonctions vitales : métabolisme des glucides, lipides (cholestérol, vitamine D) et protéines (albumine) ; épuration (destruction des hématies usées, neutralisation des toxines et des hormones, conversion de l\'ammoniac) ; stockage (vitamines A, D, E, K, glycogène, fer, cuivre, B12) ; digestion (émulsion des graisses par production de bile). Une insuffisance ou une surcharge de ces fonctions retentit sur l\'ensemble de l\'organisme.',
  'causes' => 'Surcharge liée à une alimentation trop riche en graisses/toxiques, une exposition chronique à des toxiques (alcool, médicaments, pesticides), ou une charge métabolique excessive sollicitant les cytochromes hépatiques (isoenzymes du cytochrome P450) chargés d\'éliminer médicaments et substances.',
  'signes_cliniques' => 'Signes biologiques évocateurs : cholestase (réduction ou arrêt du flux biliaire) et cytolyse hépatique (destruction des cellules hépatiques).',
  'conseils_alimentation' => 'Alimentation bénéfique pour le foie : légumes à feuilles vertes, crucifères, navet, romarin, citron, curcuma, radis noir.',
  'aliments_eviter' => 'Excès de graisses et de toxiques alimentaires ; alcool.',
  'aliments_privilegier' => 'Légumes à feuilles vertes, crucifères, navet, romarin, citron, curcuma, radis noir.',
  'conseils_activite' => 'Non détaillé spécifiquement dans la source pour ce volet (voir fiche NASH / syndrome métabolique pour les recommandations d\'activité physique liées au foie).',
  'conseils_stress' => 'Techniques de relaxation recommandées en soutien de la fonction hépatique.',
  'conseils_routine' => 'Bouillotte ou bain chaud sur le foie après le repas.',
  'complements' => 'Non détaillé spécifiquement au-delà de la phytothérapie et de l\'aromathérapie ci-dessous.',
  'phytotherapie' => 'Objectif : stimuler la fonction hépatobiliaire pour favoriser l\'élimination des toxines. Plantes cholagogues et cholérétiques : chardon-Marie, artichaut, fumeterre, boldo, radis noir. Il est recommandé d\'associer des plantes agissant sur la phase 1 et la phase 2 de la détoxification hépatique, pour ne pas se retrouver avec une accumulation de métabolites intermédiaires toxiques si l\'on ne stimule que la phase 1. IMPORTANT : avant de préconiser une plante, il faut connaître la voie métabolique d\'élimination des médicaments pris par la personne (isoenzyme du cytochrome P450 concerné) et vérifier si la plante envisagée est inductrice ou inhibitrice de cette isoenzyme, au risque de rendre le médicament inefficace ou toxique (exemple donné : alprazolam métabolisé par CYP3A4/5, associé à du millepertuis, inducteur puissant du CYP3A4/5, ce qui diminue l\'efficacité de l\'alprazolam).',
  'aromatherapie' => 'Voie orale, à envisager notamment à la suite d\'un traitement médicamenteux lourd : livèche, carotte, romarin à verbénone, lédon du Groenland, citron. Point de vigilance soulevé dans le cours : l\'ajout d\'huiles essentielles à éliminer peut alourdir davantage le travail hépatique, à peser selon le contexte.',
  'notes' => 'Rôle de la vésicule biliaire : elle emmagasine et concentre la bile (composée d\'eau, de bicarbonates, de sels biliaires, de lécithine et de pigments biliaires), indispensable à la digestion des lipides. Cette fiche complète les fiches Lithiases biliaires et NASH/syndrome métabolique, extraite du cours transversal « Bouche-pancréas » (pathologies du foie), qui couvre par ailleurs des pathologies déjà présentes dans la base (candidose buccale, gingivite, RGO, gastrite chronique, hernie hiatale) et n\'apporte pas d\'éléments nouveaux sur ces dernières.',
),
